...
export default function ExcelImportModal({
  ...
  const title =
    importType === "student" ? "นำเข้าข้อมูลนักเรียน" : "นำเข้าข้อมูลครู";
  const columns =
    importType === "student"
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-linear-to-r from-emerald-500 to-teal-500 text-white">
